...
from google_adk.adk_utils import ark_ds_model, log_before_call_llm, log_after_call_llm, ark_db20_code_model

# --- Constants ---
GEMINI_MODEL = ark_db20_code_model
# GEMINI_MODEL = ark_ds_model
...
initial_writer_agent = LlmAgent(
    ...
    after_model_callback=log_after_call_llm,
)
